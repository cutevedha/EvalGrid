...
class BaseMetric:
    ...
    def __init__(self, name: str, description: str = "", tags: List[str] = None, capabilities: List[str] = None):
        """Initialize a metric with metadata"""
        self.name = name
...
class MetricRegistry:
    ...
    @classmethod
    def register_function(cls, name: str, func: Callable, description: str = "",
                         tags: List[str] = None, capabilities: List[str] = None) -> None:
...
def register_metric(name: str, description: str = "", tags: List[str] = None, capabilities: List[str] = None):
    """
